    ...
    <div className="page">
      <div className="page-header">
        ...
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
          ...
          {youtubeConfigured && (
            <button className="btn btn-secondary" onClick={connectYouTube} disabled={connectingYouTube} style={{ borderColor: 'var(--youtube)', color: 'var(--youtube)' }}>
      ...
      {accounts.length === 0 ? (
        <div className="empty-state">
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: 14 }}>Add a social account to start scheduling posts.</p>
        </div>
      ) : (
