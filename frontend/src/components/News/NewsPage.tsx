...
import { Newspaper, Image, Send, Clock, Tag, MessageSquare, Upload, Crop, X, Loader, Dice5, Sparkles, Wand2, FileText, Trash2, Play, Edit3, Save, CheckCircle2 } from 'lucide-react';
